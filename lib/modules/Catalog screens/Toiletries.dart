...
class Toiletries extends StatefulWidget {
  String title;

  Toiletries({required String this.title});

  @override
  State<Toiletries> createState() => _catalogScreenState();
}

class _catalogScreenState extends State<Toiletries> {
