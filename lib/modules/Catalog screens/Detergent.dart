...
class Detergent extends StatefulWidget {
  ...
  Detergent({required String this.title});

  @override
  State<Detergent> createState() => _catalogScreenState();
}

class _catalogScreenState extends State<Detergent> {
        ...
        child: Column(
          children: [
            ...
            StreamBuilder<QuerySnapshot<Map<String, dynamic>>>( // inside the <> you enter the type of your stream
              stream: FirebaseFirestore.instance.collection('subCategory').where('category',isEqualTo: 'Detergent').snapshots(),
