...
class OfficeSupplies extends StatefulWidget {
  String title;

  OfficeSupplies({required String this.title});

  @override
  State<OfficeSupplies> createState() => _catalogScreenState();
}

class _catalogScreenState extends State<OfficeSupplies> {
